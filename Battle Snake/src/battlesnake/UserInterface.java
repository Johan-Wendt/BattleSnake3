...
public class UserInterface {
    ...
    public void addBacgoundImage(String name, boolean cover) {
        ...
        gameGridPane.setBorder(new Border(new BorderStroke(null, BorderStrokeStyle.SOLID, CornerRadii.EMPTY, new BorderWidths(3))));
    }
